...
//function() {
{
	...
	Tone.Drummer.prototype.eventsForSection = function(measures) {
		...
		var evts = [{
				"n":"B2","time":"0:0:2","v":0.5,"d":"0:2"
		},{ 
				"n":"B2","time":"0:1:2","v":0.7,"d":"0:2"
		},{ 
				"n":"B2","time":"0:2:2","v":0.4,"d":"0:2"
		},{ 
				"n":"B2","time":"0:3:2","v":0.5,"d":"0:2"
		},{ 
			"n":"C1","time":"1:1","v":1,"d":"0:2"
		},{ 
			"n":"C1","time":"1:2","v":1,"d":"0:2"
		},{ 
			"n":"C1","time":"1:3:2","v":1,"d":"0:2"
		},{ 
			"n":"C1","time":"1:3:3","v":1,"d":"0:2"
		},{ 
			"n":"G2","time":"2:0","v":1,"d":"1:2"
		}];
		...
		for (var m=0; m < measures; m++) {
			for (var b=0; b < 4; b++) { // beats per measure (todo: configurable?)
				...
				if (b == 0 || b == 2) { // kick
					evts.push({
						"n":"C1","time":m+":"+b,"v":1,"d":"0:2"
					});
				}
				
				if (b == 1 || b == 3) { // snare
					evts.push({
						"n":"D1","time":m+":"+b,"v":1,"d":"0:2"
					});
				}
